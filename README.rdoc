...
Ruby Version - run:<tt>ruby -v</tt>
Rails Version - run:<tt>rails -v</tt>


== Hello Rails

* Let's get started by making a Rails app for a personal website. In the terminal, type
...
* Run <tt>$ bundle install</tt>
   ...
   The <tt>bundle install</tt> command installed all the software packages needed by the new Rails app. These software pack      ages are called gems and they are listed in the file *Gemfile*.
